...
On Error Resume Next
   ...
   'Output to file
   If (ErrHandlerMode And ACLibErrorHandlerMode.aclibErrFile) = ACLibErrorHandlerMode.aclibErrFile Then
      PrintToFile ErrNumber, NewErrSource, NewErrDescription
      ErrHandlerMode = ErrHandlerMode - ACLibErrorHandlerMode.aclibErrFile
   End If

   'Show Messagebox
   If (ErrHandlerMode And ACLibErrorHandlerMode.aclibErrMsgBox) = ACLibErrorHandlerMode.aclibErrMsgBox Then
      ShowErrorMessage ErrNumber, NewErrSource, NewErrDescription
      ErrHandlerMode = ErrHandlerMode - ACLibErrorHandlerMode.aclibErrMsgBox
   End If
